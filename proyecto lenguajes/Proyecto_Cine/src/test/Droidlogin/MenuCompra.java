...
public class MenuCompra extends Activity{
	Button bcanguil=null;
	Button bbebidas=null;
	Button bgenerar=null;
	TextView saldo_disponible=null;
	TextView valor_total=null;
	String total,nombre,apellido,sala,asiento,funcion,arreglo_base_canguil,arreglo_base_bebida,arreglo_base_hot,arreglo_base_nacho,cedu,cinenombre;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        bcanguil=(Button)findViewById(R.id.grupo_canguil);
        bbebidas=(Button)findViewById(R.id.grupo_bebidas);
        bgenerar=(Button)findViewById(R.id.genera_pedido);
