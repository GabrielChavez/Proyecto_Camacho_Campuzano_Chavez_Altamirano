       ...
       rb2 = (RadioButton)findViewById(R.id.cine2);
        ...
        rb1.setOnClickListener(new RadioButton.OnClickListener(){
            public void onClick(View v) {
            	//coordenada_latitud=(int) (-2.139959 * 1E6);
            	//coordenada_longitud=(int) (-79.909401 * 1E6);
        ...
        rb2.setOnClickListener(new RadioButton.OnClickListener(){
            public void onClick(View v) {
            	//coordenada_latitud=(int) (-2.154743 * 1E6);
            	//coordenada_longitud=(int) (-79.891076 * 1E6);
        ...
        rb3.setOnClickListener(new RadioButton.OnClickListener(){
            public void onClick(View v) {
            	//coordenada_latitud=(int) (-2.22875 * 1E6);
            	//coordenada_longitud=(int) (-79.89894 * 1E6);
