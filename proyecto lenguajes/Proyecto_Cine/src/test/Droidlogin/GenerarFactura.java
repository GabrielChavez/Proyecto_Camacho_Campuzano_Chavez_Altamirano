...
public class GenerarFactura extends Activity{
	...
	String nombre,apellido,saldo,sala,asiento,funcion,total,hora_temporal,pedido;
	int descuento;
	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.generarpedido);
        post=new Httppostaux();
        guardar_pedido=(Button)findViewById(R.id.boton_guardar_registro);
        cancelar_pedido=(Button)findViewById(R.id.boton_cancelar_registro);
